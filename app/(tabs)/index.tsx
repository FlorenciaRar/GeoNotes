  ...
  return (
    <Container style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {/* Grid 2x2 (mismo orden, 2 por fila) */}
        <View style={styles.quickGrid}>
          <View style={styles.tileWrap}>
            <QuickAccessItem
              link="/Notes"
              iconName="note"
              name="Todas mis notas"
            />
          </View>
          <View style={styles.tileWrap}>
            <QuickAccessItem
...
function getStyles(themes: DefaultTheme) {
  return StyleSheet.create({
    ...
    quickGrid: {
      ...
      rowGap: themes.spacing.md, // espacio vertical entre filas
    },
    tileWrap: {
      width: "45%", // dos por fila con espacio entre ellas
      // opcional: asegura altura mínima homogénea para todos los QuickAccessItem
      // minHeight: 96,
    },
